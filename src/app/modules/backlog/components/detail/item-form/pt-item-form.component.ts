...
import { KENDO_TEXTAREA, KENDO_TEXTBOX , KENDO_SLIDER} from '@progress/kendo-angular-inputs';
...
export class PtItemFormComponent implements OnInit {
  ...
  public getPriorityClass(priority: PriorityEnum): string {
    return PriorityEnum.getIndicatorClass(priority);
  }

  public getIndicatorImage(type: PtItemType): string {
    return ItemType.imageResFromType(type);
  }
